...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_100000) do
  ...
  create_table "hitch_clients", force: :cascade do |t|
    ...
    t.check_constraint "token_endpoint_auth_method::text = ANY (ARRAY['none'::text, 'client_secret_basic'::text])", name: "hitch_clients_auth_method_check"
  end
  ...
  create_table "hitch_device_grants", force: :cascade do |t|
    ...
    t.check_constraint "token_endpoint_auth_method::text = ANY (ARRAY['none'::text, 'client_secret_basic'::text])", name: "hitch_device_grants_auth_method_check"
  end
